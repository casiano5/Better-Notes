...
namespace BetterNotes {
    public static class GlobalVars {
        ...
        public readonly static SolidColorBrush ManageUnHighLight = (SolidColorBrush)new BrushConverter().ConvertFromString("#FF2E144B");//colored button unhigliging
        ...
        public readonly static SolidColorBrush MainText = (SolidColorBrush)new BrushConverter().ConvertFromString("#FFE0F500");//Main Text color
